...
"use strict";
/**
 * Created by Mello on 17.09.2017.
 */
...
exports.bookFieldNames = bookFieldNames;
...
(function () {
    new Promise(function (resolve) {
        var dataDownload = __webpack_require__(183);
...
var _addBook = __webpack_require__(182);

var _bookFieldNames = __webpack_require__(88);

var TableBook = (function (_React$Component) {
    _inherits(TableBook, _React$Component);

    function TableBook() {
        _classCallCheck(this, TableBook);

        _get(Object.getPrototypeOf(TableBook.prototype), 'constructor', this).call(this);
        this.state = {
            filterString: '',
            sortBook: false,
    ...
    _createClass(TableBook, [{
        ...
        key: 'showModalWindow',
        value: function showModalWindow(selectedBook) {
            this.setState({
        ...
        value: function deleteBook(book) {
            var books = this.state.books.filter(function (item) {
        ...
        key: 'editBook',
        value: function editBook(editedBook) {
        ...
        key: 'hideModalWindow',
        value: function hideModalWindow() {
            this.setState({
                isModalWindowOpened: false
            });
        }
        ...
        key: 'getFilteredTable',
        value: function getFilteredTable() {
            var _this = this;

            var allBook = this.props.allBook;

            if (this.state.filterString) {
                return allBook.filter(function (item) {
                    for (var key in item) {
                        if (String(item[key]).toLowerCase().indexOf(_this.state.filterString) > -1 && key !== 'id') {
                            return true;
                        }
                    }
        ...
        value: function render() {
            ...
            var bookFields = Object.keys(_bookFieldNames.bookFieldNames);
            var headers = bookFields.map(function (fieldName) {
                return _bookFieldNames.bookFieldNames[fieldName];
            });
            var allBook = this.getFilteredTable();
            ...
            return _react2['default'].createElement(
                    ...
                    _react2['default'].createElement(
                        ...
                        _react2['default'].createElement('input', { type: 'text', placeholder: 'Поиск',
                            ...
                            onChange: function (event) {
                                return _this2.refreshFilterString(event);
                            } }),
                        _react2['default'].createElement(
                            'button',
                            { type: 'button',
                                ...
                                onClick: function () {
                                    return _this2.showModalWindow(null);
                                } },
                            'Добавить книгу'
                        )
                    )
                ...
                _react2['default'].createElement(
                    'div',
                    null,
                    _react2['default'].createElement(_addBook.AddBook, { selectedBook: this.state.selectedBook,
                        visibility: this.state.isModalWindowOpened,
                        onDelete: function (book) {
                            return _this2.deleteBook(book);
                        },
                        onEdit: function (book) {
                            return _this2.editBook(book);
                        },
                        onAdd: function (book) {
                            return _this2.addBook(book);
                        },
                        onCancel: function () {
                            return _this2.hideModalWindow();
                        } }),
                    _react2['default'].createElement(
                        'div',
                        { className: 'allBooks' },
                        allBook.map(function (book, id) {
                            return _react2['default'].createElement(
                                'div',
                                ...
                                _react2['default'].createElement(
                                    ...
                                    bookFields.map(function (internal, i) {
                                        return _react2['default'].createElement(
                                            'div',
                                            { key: i, id: internal },
                                            ' ',
...
var AddBook = (function (_React$Component) {
    ...
    function AddBook() {
        ...
        _get(Object.getPrototypeOf(AddBook.prototype), 'constructor', this).call(this);
        this.state = _extends({}, DEFAULT_BOOK);
    }

    _createClass(AddBook, [{
        key: 'componentWillReceiveProps',
        value: function componentWillReceiveProps(_ref) {
            var selectedBook = _ref.selectedBook;
        ...
        value: function render() {
            ...
            var selectedBook = _props.selectedBook;
            ...
            return _react2['default'].createElement(
                ...
                _react2['default'].createElement(
                    'div',
                    { className: 'modalWindow ' + (visibility ? 'modalVisible' : 'modalNoVisible') },
                    _react2['default'].createElement(
                        'div',
                        ...
                        _react2['default'].createElement('img', { className: 'closeModal', src: '../img/close.png', alt: 'close', onClick: onCancel })
                    ),
                    _react2['default'].createElement(
                        'div',
